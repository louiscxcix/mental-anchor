#!/bin/bash
# Docker Buildx Build Script for mental-anchor
# Individual project build with multi-platform support

set -e

PROJECT_NAME="mental-anchor"
...
Build Docker image for $PROJECT_NAME using buildx.
...
BUILD_CMD="$BUILD_CMD --tag=$REGISTRY/$PROJECT_NAME:latest"
BUILD_CMD="$BUILD_CMD --tag=$REGISTRY/$PROJECT_NAME:$TIMESTAMP"
...
if eval "$BUILD_CMD"; then
    ...
    echo -e "  Image: $REGISTRY/$PROJECT_NAME:latest"
    echo -e "  Image: $REGISTRY/$PROJECT_NAME:$TIMESTAMP"
else
    echo ""
